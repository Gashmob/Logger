...
- Le test Windows pour C++ ne fonctionne pas : la compilation réussi mais l'exécutable renvoie directement le code 1 sans rien afficher ([#3](https://github.com/Gashmob/Logger/issues/3))
